...
interface RecordDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

// 🚀 Internal RecordDataTable component for optimization
function RecordDataTableComponent<TData, TValue>({
  columns,
  data,
}: RecordDataTableProps<TData, TValue>) {
...
export const RecordDataTable =
  RecordDataTableComponent as typeof RecordDataTableComponent;
